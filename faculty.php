    ...
    <main style="margin-top:80px">
        <section>
            <div class="about-section">
                <h1 class="main-heading-title">Faculty</h1>
                <div class="main-heading-bot"></div>
                <div class="about-p">
                    <p>Our school offers experienced teachers</p>
                    <p>They have expertise in their respective field of subject and are well experienced</p>
                </div>
        </section>
        <div class="container">
